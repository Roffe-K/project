          ...
          <nav className="hidden lg:flex items-center space-x-6">
            ...
            {user && (
              <>
                ...
                <RouterLink to="/drinks" className={`relative ${currentPath === '/drinks' ? 'text-green-400 font-semibold' : 'text-white hover:text-green-400 transition-colors'}`}>Drinkar</RouterLink>
