...
const DrinksPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 pt-24">
      <div className="bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 py-20 px-4">
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mb-8 text-gray-300">
          <p className="text-lg">{filteredDrinks.length} {filteredDrinks.length === 1 ? 'recipe' : 'recipes'} found</p>
        </div>
